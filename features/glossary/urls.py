...
urlpatterns = [                    
    ...
    path('add-glossary-entry/<int:glossary_id>/',
        views.AddGlossaryEntry.as_view(), name='add_glossary_entry'),
    path('edit-glossary-entry/<int:glossary_id>/<int:glossary_entry_id>/',
        views.ManageGlossaryEntry.as_view(), name='edit_glossary_entry'),
    path('get-glossary-entries/<int:glossary_id>/',
        views.GetGlossaryEntries.as_view(), name='get_glossary_entries'),
    path('get-glossary-entry/<int:glossary_entry_id>/',
