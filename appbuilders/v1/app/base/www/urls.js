...
var urlpatterns = urlpatterns.concat([
	...
	path("observation/new/<str:taxon_source>/<uuid:name_uuid>/<str:taxon_nuid>/<str:taxon_latname>/", ObservationView.as_view(), {"name" : "GenericForm"}),
	...
	path("taxon-profile/<str:taxon_source>/<uuid:name_uuid>/<str:taxon_nuid>/<str:taxon_latname>/", TaxonProfiles.as_view(), {"name" : "TaxonProfiles"}),
	path("taxon-profile/<str:taxon_source>/<uuid:name_uuid>/", TaxonProfiles.as_view(), {"name" : "TaxonProfilesUUID"}),
	path("occurrence-map/<str:gbif_nubKey>/", OccurrenceMap.as_view(), {"name" : "occurrence_map"}),
